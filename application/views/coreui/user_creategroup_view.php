<div class="container-lg">
   <div class="row">
      <div class="col-12">
         <div class="card mb-4">
            <div class="card-header"><strong><?php echo lang('create_group_heading'); ?> </strong><span class="small ms-1"><?php echo lang('create_group_subheading'); ?></span></div>
            <div class="card-body">
               ...
               <div class="example">
                  ...
                  <div class="tab-content rounded-bottom">
                     <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-49">
                        <?php echo form_open('Users/create_group', array('class' => 'row')); ?>
                        <div class="col-md-6">
